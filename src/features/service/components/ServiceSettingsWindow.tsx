              ...
              {serviceConfig.trackingSource === "externalApi" ? (
                <>
                  ...
                  <div className="settings-field-help settings-field-help-warning">
                    Aktifkan hanya untuk deployment LAN tepercaya. Endpoint metadata dan
                    localhost tetap ditolak.
                  </div>
          ...
          >
            <div className="service-settings-stack">
              <div className="settings-field-help settings-field-help-info">
                Token di bawah hanya untuk aplikasi pihak ketiga. ShipFlow Desktop tidak memakai
                atau menampilkan token internalnya.
              </div>
              ...
              {serviceConfig.mode === "lan" ? (
                <div className="settings-field-help settings-field-help-warning">
                  LAN membuka API publik ke perangkat lain dalam jaringan yang sama. Desktop tetap
                  memakai localhost.
                </div>
              ) : null}

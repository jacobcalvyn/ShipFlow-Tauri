...
> {
  const sheetTabsProps = useWorkspaceTabsProps({
    ...
    previewDesktopServiceUrl: surface.previewDesktopServiceUrl,
    previewDesktopServiceAuthToken: surface.previewDesktopServiceAuthToken,
    pasteDesktopServiceAuthToken: surface.pasteDesktopServiceAuthToken,
    ...
    testApiServiceConnection: surface.testApiServiceConnection,

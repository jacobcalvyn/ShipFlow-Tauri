  ...
  it("maps surface, view model, refs, and interaction runtime into shell view props", () => {
    ...
    const sheetViewModel = {
      ...
      analyticsSummary: {
        ...
        totalMetricValue: 0,
        rowPaths: ["status_akhir.status"],
        rowLabel: "Status Akhir",
        rowLabels: ["Status Akhir"],
        columnPaths: [],
        columnLabel: "",
        columnLabels: [],
        valueMetrics: [],
    ...
    expect(result.current).toEqual({
      ...
      sheetAnalyticsViewProps: {
        ...
        onRowPathsChange: expect.any(Function),
        onColumnPathsChange: expect.any(Function),
        onValueMetricsChange: expect.any(Function),
